...
<body>
        ...
        <main>
            ...
            <div class="container" id="container-princial">
                ...
                <form class="needs-validation" method="post" action="buscarImovelADM.php" novalidate>
                    <div class="form-row">
                        <div class="col">
                ...
                <!-- CARDS DOS IMÓVEIS -->
                <?php 
                    $sql2 = "SELECT `idimoveis`,`imgnome1`, `situacao`, `tipo`,`valor`, `descricao`, `bairro` FROM `imoveis` WHERE 1";

                    $resultado2 = mysqli_query($conexao,$sql2);
                
                    $linhasAfetadas2 = mysqli_affected_rows($conexao);
                    $qtd = mysqli_num_rows($resultado2);
                        ...
                        while ($dados2 = mysqli_fetch_assoc($resultado2)) { 
                            ...
                            echo '<div class="item col-xs-4 col-lg-4 mt-4">
                                    <div class="thumbnail card">
                                        <div class="img-event">
                                            <img class="card-img-top img-fluid" src="arquivo/arquivo_img/'.$dados2["imgnome1"].'"/>
                                        </div>
                                        <div class="caption card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-md-4">
                                                    <p class="lead"> R$'.$dados2["valor"].',00</p>
                                                    
                                                </div>
                                                <br><br>
                                                <div class="col-xs-12 col-md-4">
                                                    <a class="btn btn-success" href="formEditarImovel.php?id='.$dados2['idimoveis'].'">Editar</a>
                                                </div>
                                                <div class="col-xs-12 col-md-4">
                                                    <a class="btn btn-danger" href="excluirImovel.php?id='.$dados2['idimoveis'].'">Deletar</a>
                                                </div>
                            ...
                            <div class="row text-center text-xs-center text-sm-left text-md-left">
                                <div class="col-xs-12 col-sm-4 col-md-4">
                                    ...
                                    <ul class="list-unstyled quick-links">
                                        ...
                                        <li><a><i class="fa fa-angle-double-right"></i>Rua: Gen. Bento Martins</a></li>
                                        <li><a><i class="fa fa-angle-double-right"></i>Número: 2778</a></li>
                                        <li><a><i class="fa fa-angle-double-right"></i>Bairro: Centro</a></li>
                                        <li><a><i class="fa fa-angle-double-right"></i>Sala: 07</a></li>
                                    </ul>
                                </div>
                                <div class="col-xs-12 col-sm-4 col-md-4">
