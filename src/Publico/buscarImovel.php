            ...
            <div class="container" id="container-princial">
                ...
                <?php 
                                        ...
                                        <div class="thumbnail card">
                                            ...
                                            <div class="caption card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <br><br>
                                                    <div class="col-xs-12 col-md-6">
                                                    <a class="btn btn-success" href="visualizarImovel.php?id='.$dados['idimoveis'].'">Visualizar</a>
                                                    </div>
                    ...
                    if (empty($bairro) && empty($situacao)) {
                        ...
                        $sql="SELECT * FROM `imoveis` WHERE `bairro`=\"$bairro\" and `situacao`=\"$situacao\" and `tipo`=\"$tipo\" ";
                        $resultado = mysqli_query($conexao,$sql);
                        $linhasAfetadas = mysqli_affected_rows($conexao);
                        if($linhasAfetadas > 0){
                            $n=1 ;
