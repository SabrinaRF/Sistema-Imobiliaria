                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">    
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="aboutus-content ">
                                    <h2><p><span>Corretora de Imóveis</span></p>
                                    <br>
                                    <p>Olá, meu nome é Imobiliaria DEVmob, sou corretora de imóveis com inscrição no CRECI-RS sob n° xxxxxx. Queremos oferecer a você uma assessoria pesonalizada com toda a segurança jurídica para seu negócio.</p>
                                    <p>Nosso propósito consiste em oferecer excelentes oportunidades de compra e venda de imóveis, além administração de locações, com agilidade e eficiência, mediante um trabalho ético, com lisura e profissionalismo.</p>
                                    <p>Eu e minha equipe gostaríamos de poder contribuir com o seu sonho.</p>
                                    <!--ARRUMAR IMAGEM -->
